...
@Component({
  selector: 'app-repeticiones-lista',
  templateUrl: './repeticiones-lista.component.html',
  styleUrls: ['./repeticiones-lista.component.css']
})
export class RepeticionesListaComponent implements OnInit {
